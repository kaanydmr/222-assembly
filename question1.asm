...
values: .word 3, 5, 7, 10, 20, -4, -99, 6, 8, -7 #10 numbers
...
blt $t2, $t1, update		#if t2 is smaller, sets the new smallest number to minValue
				#if not minValue is still minimum value
addi $t0 ,$t0, 4		#next array number
addi $t6, $t6, 1		#counter + 1
j loop				#whle loop

update:
add $t1, $t2, $zero		#sets the new smallest number to minValue
